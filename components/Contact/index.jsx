const Contact = () => {
  return (
    <section id="contact" className="overflow-hidden py-16 md:py-20 lg:py-28">
      <div
        className="wow fadeInUp relative z-10 m-auto w-full rounded-md bg-primary/[3%] p-8 px-4 dark:bg-primary/10 sm:p-11 lg:w-7/12 lg:p-8 xl:w-8/12 xl:p-11"
        data-wow-delay=".2s"
      >
        ...
        <form
          action="https://formsubmit.co/soporte@bubbletic.com"
          method="POST"
        >
